...
// if everything is ok, try to upload file
  ...
  /*if(!empty($_POST["email"])) {
    ...
    echo '<script>alert("Wrong email format");window.location.href="signup1.php";</script>';
  }
  if(strlen("$password")<6)
  {
    echo '<script>alert("Password must be more than 6 characters");window.location.href="signup1.php";</script>';
  }
  else if($confirmpassword!=$password)
  {
    echo '<script>alert("Passwords Must Match");window.location.href="signup1.php";</script>';
  }
  else{
